...
//‘this’ is the object itself (‘joe’) that is invoking that function.
// 2. What is "this" when joe.scopeArrow() is invoked?
//  ‘this’ is the instance of windows itself
// 3. Explain why "this" is different when an arrow function is used.
// It is because when using arrow function would make it go out of current scope of function.
